...
<form name="form1" id="form_list_size" action="" method="post">
    ...
    <div class="content-box content-wpmf-general content-active">
        ...
        <div class="cboption">
            <h3 class="title"><?php _e('Search all attachment function','wpmf'); ?></h3>
            <p><input data-label="wpmf_option_searchall" type="checkbox" name="cb_option_searchall" class="cb_option" id="cb_option_searchall" <?php if ($option_searchall == 1) echo 'checked' ?> value="<?php echo @$option_searchall ?>">
                <?php _e('Search all attachment', 'wpmf') ?>
            </p>
            <p class="description"><?php _e('Possibility to search media files in all folders.','wpmf'); ?></p>
        </div>
    ...
    <div class="content-box content-box content-wpmf-ftp-import">
        ...
        <p style="margin-left:10px;" class="description"><?php _e('Import folder structure and media from your server in the standard WordPress media manager','wpmf'); ?></br>7z,bz2,gz,rar,tgz,zip,csv,doc,docx,ods,odt,pdf,pps,ppt,pptx,rtf,txt,xls,xlsx,bmp,psd,tif,tiff,mid,mp3,mp4,ogg,wma,3gp,avi,flv,m4v,mkv,mov,mpeg,mpg,swf,vob,wmv</p>
    </div>
    <!--------------------------------------- End FTP Import ----------------------------------->
